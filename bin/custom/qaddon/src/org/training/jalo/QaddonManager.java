...
import org.training.constants.QaddonConstants;



/**
 * This is the extension manager of the Qaddon extension.
 */
public class QaddonManager extends GeneratedQaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QaddonManager.class.getName());
	 ...
	 */
	public static QaddonManager getInstance()
	{
		return (QaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
